...
import scau.edu.cn.notebook.dialog.InputLocationDialog;
import scau.edu.cn.notebook.dialog.SelectDateDialog;
import scau.edu.cn.notebook.dialog.SelectEventSetDialog;
...
import scau.edu.cn.notebook.task.LoadEventSetMapTask;
import scau.edu.cn.notebook.task.UpdateScheduleTask;
import scau.edu.cn.notebook.utils.DateUtils;
import scau.edu.cn.notebook.utils.JeekUtils;
...
public class ScheduleDetailActivity extends BaseActivity implements View.OnClickListener, OnTaskFinishedListener<Map<Integer, EventSet>>, SelectDateDialog.OnSelectDateListener, InputLocationDialog.OnLocationBackListener, SelectEventSetDialog.OnSelectEventSetListener {
    ...
    private void confirm() {
        if (etScheduleTitle.getText().length() != 0) {
            ...
            ToastUtils.showShort(this, R.string.schedule_input_content_is_no_null);
        }
    }
