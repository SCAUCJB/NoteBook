...
import scau.edu.cn.notebook.helper.CountDownButtonHelper;
import scau.edu.cn.notebook.impl.NoteModelImpl;
import scau.edu.cn.notebook.model.UserModel;
import scau.edu.cn.notebook.utils.StringUtils;
        ...
        switch (view.getId()) {
            ...
            case R.id.register_get_check_pass:
                if (StringUtils.isMobileNO(registerPhone.getText().toString())) {
                    mUserModel.isPhoneRegister(registerPhone.getText().toString(), new NoteModelImpl.BaseListener() {
                        @Override
